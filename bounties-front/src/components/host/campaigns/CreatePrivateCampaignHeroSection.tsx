...
const steps = [
  ...
  { id: "select-kols", label: "Select Creators", icon: "users", isReactIcon: true },
  { id: "rewards", label: "Rewards", icon: "/assets/host/campaign/rewardIcon.svg" }
];

interface CreatePrivateCampaignHeroSectionProps {
  currentStep: string;
  isEditing?: boolean;
}

export default function CreatePrivateCampaignHeroSection({ currentStep, isEditing = false }: CreatePrivateCampaignHeroSectionProps) {
